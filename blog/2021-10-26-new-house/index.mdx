...
For example: the previous owners did not understand lightbulbs. You may already know, but lightbulbs have a "temperature" rating that indicates how "warm" or "cool" their light is. Most light fixtures in this house have two bulbs, and _every_ one of those had one "warm" bulb and one "cool" bulb. Were they yrying to blend harsh blue and rusty orange into a perfect synthesis? It's unclear. The disparency drove me nuts when we first took possesion! I vowed to unify the bulbs under a common kelvin degree, but sometime after I got the main living area under one bulb, I lost steam.
