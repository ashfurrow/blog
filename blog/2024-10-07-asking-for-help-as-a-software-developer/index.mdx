...
Think about it another way: if you got stuck on a problem for two days when asking for help would have gotten you unstuck in a half hour, was that a good use of time two days? Is it helping you improve your skills? Is it helping you accomplish your task?
...
>
> I'm not sure what could have caused this, since the code was compiling fine yesterday. I didn't change anything on my computer. Any ideas? I'm going to keep going down the rabbit hole searching for the compiler error for now.
