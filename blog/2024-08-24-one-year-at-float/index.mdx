...
I joined in late August to lead mobile development and by early December, [Float had launched its mobile app on Android and iOS](https://floatcard.com/introducing-the-float-mobile-app/). Financial services was a whole new domain to me and I had to get up to speed _fast_. I learned Float's existing products, met with Float's customers, and asked so many questions. At the same time, I guided our small team through the planning, design, build, test, and deploy phases of a new product.

All in three months.

I learned a lot, but the most valuable lessons were what I learned about myself.

It turns out that I actually respond really well to external pressure. So long as I understand _why_ something is important. For example, two days before the app launch, on a Sunday, we discovered a show-stopping bug. My evening was spent on a call with two other developers and our product manager; we identified the problem, fixed it gracefully, and deployed that fix to unblock our launch.
...
My time at Float has reconnected me with my vocation.
...
At home in my office, I can get a lot of code written. But anyone who has worked with me would tell you that the code I write is not always the most important contribution I make. The relationships with my coworkers and the context I gather from them helps me understand what is the most important thing to do at any moment. Sometimes that's coding. Often it's something else.

During two years at my previous employer, I got to meet my coworkers in-person _once_. In contrast, I've actually lost track of how many times I've met my coworkers in-person at Float.
...
By spending half my career at Artsy, I had learned to work with art-adjacent people solving problems for the art world. Float solves problems for businesses. I work with business-adjacent people. Ideas and opinions that were "taken as read" at one place need to be argued from first principles at the other. It shouldn't be surprising that some skills that worked at Artsy don't work at Float, or needed to be modified.
...
I feel confident again. Outspoken. Intent on doing what I think is right.
...
[I applied my professional philosophy](/blog/building-better-software-by-building-better-teams/) and it worked. I focused on _learning how to build a great product_ as a team, and lo: a great product was made as a byproduct. This was a team effort, and I take a lot of pride in my supportive leadership. I made sure at every critical step, from `git init` to `yarn release`, we worked together as team so we could all share the sense of accomplishment.
...
I feel it in my bones that my time at Float has already been worthwhile. I've grown. I am more competent and confident as a technical leader now than when I joined. I learned a lot about software development and my technical skills are sharper than ever. I've built products to a level of quality that I am satisfied with.

But most importantly, I've been an open an honest version of myself. I have "brought my whole self to work" at a time when [that sense of self is shifting](/blog/new-year-new-me/). My first criteria in my job search was to find a company with good people. My team have made it easy to be that honest self. When I have "done technical leadership" in my own unique way, I get encouraged to go further. It's a virtuous cycle.

So much of what I bring to a company is building up context and relationships. I want to stay at companies a long time because I have increasing returns the longer I am there. Part of that work is making the company worth staying at for a long time, and I feel empowered to make that happen.
