  ...
  entries={[
    ...
    },
    {
      ...
      description: [
        ...
        'To be honest, I don’t really remember much from that six-month time period. What I include in this timeline is largely reconstructued from blog posts, git commits, and screenshots. '
      ]
    },
    {
      ...
      description: [
        ...
        'All that changed when my sister had her first child. Something in my brain switched on, and it was clear: we wouldn’t be moving even a single kilometer further from that baby. So Vancouver was out of the picture.',
    ...
    },
    {
      ...
      img: cultureamp,
      imgAlt:
        'Screenshot of a survey question inquring my sexuality, with Bisexual as the selected answer',
      description: [
    ...
    },
    {
      ...
      description: [
        ...
        'Treatment is ongoing, but I feel like we’re almost there. As a programmer, repitive stress injuries can be really frightening. If you’re struggling with pain, please seek treatment. And before undergoing drastic interventions, make sure to get a second opinion. '
      ]
    },
    {
      date: '2019'
    },
    {
      ...
      img: buynow,
      imgAlt:
        'Photo of the Artsy office with people celebrating in front of ballons that spell out BUY NOW',
      description: [
    ...
    },
    {
      ...
      description: [
        ...
        'I realized that seeing <em>myself</em> on the screen also changed how I think about remoting meetings, and remote work in general. '
      ]
    },
    {
      title: 'Discover Team',
    ...
    },
    {
      ...
      description: [
        'I had stabilized my mood through Cognitive Behavioural Therapy in 2018, but I kept on my psychiatric medication. The idea was to make sure I was stabilzed before adjusting anything.',
    ...
    },
    {
      ...
      description: [
        ...
        "At time of writing, my instance has 19 344 users (many are inactive, only 1 161 have logged in within the past two weeks). Keeping up with software updates and server maintenance turned out to be the easy part – I know my way around computeres, and have <a href='https://www.patreon.com/ashfurrow/posts'> shared what I learn as I go </a> . The harder part was building the community.",
    ...
    },
    {
      ...
      description: [
        "After the Discover team dissolved, I joined Artsy’s Grow team to help them complete <a href='https://www.architecturaldigest.com/story/artsy-app-changing-the-game-for-art-and-design-lovers'> City Guides </a> , as an in-progress project. I wasn’t used to joining in-prorgress work; I prefer to be involved throughout the product development process: brainstorming with stakeholders, providing early design feedback, that kind of stuff. This was a new challenge.",
    ...
    },
    {
      ...
      img: comingout,
      imgAlt:
        'A panel from a comic that says How do I feel? Oh you know. Relieved. Excited. Devastatingly embarassed by my own idiocy.',
      description: [
