...
If you want to get in touch, [Mastodon](https://masto.ashfurrow.com/@ashfurrow) is probably the best way to reach me. Only if you have to, you can email [ash@ashfurrow.com](mailto:ash@ashfurrow.com).
...
I've been working on the [Shop app](https://shop.app) ever since [I joined Shopify](/blog/joining-shopify/). My deep expertise in React Native allows me to push myself in many directions; my role as Senior Staff Developer affords me the autonomy to decide where I can drive the most impact.

My largest contribution so far has been [Shop Minis](https://shop.app/minis), a React Native SDK for third parties to build native-quality shopping experiences. I held the technical vision for the SDK, even as the Shop app itself was finding product-market fit. First I started building the SDK on my own, then I built up a team to deliver our internal prototype, then finally I oversaw two teams delivering a private alpha to launch partners. As I moved on from the project, the teams were preparing for [the public SDK launch](https://www.shopify.com/ca/editions/winter2023#shop-minis-sdk).
