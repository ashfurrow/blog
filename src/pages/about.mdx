...
If you want to get in touch, [Mastodon](https://tenforward.social/@ashfurrow) is probably the best way to reach me. Only if you have to, you can email [ash@ashfurrow.com](mailto:ash@ashfurrow.com).
...
My first job was to lead development of [the Float mobile application](https://floatcard.com/introducing-the-float-mobile-app/). Since then, I've been leveraging my experience [making Artsy a mobile-first product team](https://artsy.github.io/blog/2020/09/29/becoming-mobile-first-at-artsy/) to ship products and features to save Canadian businesses time and money.
...
I'm proud of what I have accomplished so far and I'm grateful for the chance to work with such a talented group of people.
