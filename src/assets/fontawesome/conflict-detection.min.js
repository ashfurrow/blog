...
;((t) => {
  ...
  function p(t) {
    if (null !== t && "object" == typeof t)
      return t.src ? m(t.src) : t.href ? m(t.href) : t.innerText && "" !== t.innerText ? m(t.innerText) : void 0
  }
  let w = "fa-kits-diag",
          ...
          e = Array.from(d.getElementsByTagName("style")).filter(
            (t) =>
              !(
                t.hasAttribute(A) ||
                (l.FontAwesomeConfig &&
                  t.innerText.match(new RegExp("svg:not\\(:root\\)\\.".concat(l.FontAwesomeConfig.replacementClass))))
              )
          )
        function n(t, e) {
              ...
              if (0 < (a = Object.keys(r).length)) {
                ...
                for (u in r) {
                  ...
                  h[u] = {
                    ...
                    "innerText excerpt":
                      g.innerText && "" !== g.innerText ? g.innerText.slice(0, 200) + "..." : "(empty)"
                  }
                }
                console.table(h)
              }
