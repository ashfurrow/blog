      ...
      o
        ...
        : (({ children: p, main: d, mask: m, attributes: g, styles: v, transform: h } = h),
          At(h) &&
            ...
            (m = { x: m / d / 2, y: 0.5 }),
            (g.style = A(
              b(b({}, v), {}, { "transform-origin": "".concat(m.x + h.x / 16, "em ").concat(m.y + h.y / 16, "em") })
            ))),
            ...
            return (
              ...
              (i =
                (i += "scale("
                  ...
                  .concat((e.size / p) * (e.flipY ? -1 : 1), ") ")) + "rotate(".concat(e.rotate, "deg) "))
            )
      ...
      icon: (n = Array.isArray(r)
        ? {
            ...
            children: [
              {
                tag: "path",
                attributes: { class: "".concat(x.cssPrefix, "-").concat(vt.SECONDARY), fill: "currentColor", d: r[0] }
              },
              {
                tag: "path",
                attributes: { class: "".concat(x.cssPrefix, "-").concat(vt.PRIMARY), fill: "currentColor", d: r[1] }
              }
            ]
          }
  ...
  function de(i, o) {
    ...
    return (
      ...
      new Promise((t, e) => {
        var a, r, n
        if (
          ("fa" === s && ((a = Vt(i) || {}), (i = a.iconName || i), (o = a.prefix || o)), i && o && fe[o] && fe[o][i])
        )
          return t(ce(fe[o][i]))
        ;((r = i),
          (n = o),
    ...
    replace: function (t) {
      ...
      e.parentNode &&
        ...
        null === e.getAttribute(y) && x.keepOriginalSource
          ? ((a = g.createComment(
              ((t = e), (a = " ".concat(t.outerHTML, " ")), "".concat(a, "Font Awesome fontawesome.com "))
            )),
      ...
      ;(delete a[0].attributes.id,
        a[0].attributes.class &&
          ((n = a[0].attributes.class
            .split(" ")
            .reduce((t, e) => ((e === x.replacementClass || e.match(r) ? t.toSvg : t.toNode).push(e), t), {
              toNode: [],
              toSvg: []
            })),
  ...
  function Se(t) {
    ...
    return (
      ...
      (o.iconName && o.prefix) ||
        (o.prefix &&
          0 < i.length &&
          (o.iconName = ((e = o.prefix), (a = t.innerText), (Ht[e] || {})[a] || qt(o.prefix, Ft(t.innerText)))),
        !o.iconName &&
          x.autoFetchSvg &&
          t.firstChild &&
          ...
          counter(n) {
            ...
            return oe({ type: "counter", content: n }, () => {
              ...
              var {
                  ...
                  content: n.toString(),
                  title: o,
                  extra: { attributes: l, styles: f, classes: ["".concat(x.cssPrefix, "-layers-counter"), ...s] }
                },
      ...
      provides(t) {
        t.generateLayersText = function (t, e) {
          ...
          return (
            ...
            Promise.resolve([
              t,
              le({ content: t.innerHTML, width: s, height: l, transform: i, title: n, extra: o, watchable: !0 })
            ])
          )
        }
      }
        ...
        if (
          ...
          ;((n.attributes[at] = h),
            de(e, i)
              .then((t) => {
                var e = se(
                    b(b({}, r), {}, { icons: { main: t, mask: Gt() }, prefix: i, iconName: o, extra: n, watchable: !0 })
                  ),
            ...
            children: [
              {
                ...
                children: [
                  { tag: e.icon.tag, children: e.icon.children, attributes: b(b({}, e.icon.attributes), r.path) }
                ]
              }
            ]
          }
      ...
      provides(t) {
        t.generateAbstractMask = function (t) {
          var { children: e, attributes: a, main: r, mask: n, maskId: i, transform: o } = t,
            ...
            i = {
              tag: "mask",
              attributes: b(b({}, Ze), {}, { id: o, maskUnits: "userSpaceOnUse", maskContentUnits: "userSpaceOnUse" }),
              children: [n, r]
            },
            n = {
              tag: "defs",
              children: [
                { tag: "clipPath", attributes: { id: s }, children: "g" === (t = l).tag ? t.children : [t] },
                i
              ]
            }
          return (
            e.push(n, {
              tag: "rect",
              attributes: b(
                { fill: "currentColor", "clip-path": "url(#".concat(s, ")"), mask: "url(#".concat(o, ")") },
                Ze
              )
            }),
            { children: e, attributes: a }
