...
date: 2019-12-15
banner: pairing.jpg
pageStylesheet: /assets/personal-timeline.css
timeline_entries:
  - date: "2015"
  ...
  - title: "Leaving Amsterdam"
    ...
    description:
      ...
      - "Two weeks before I left Amsterdam, something really special happened: Artsy hired [Eloy Durán](https://twitter.com/alloy) of CocoaPods and RubyMotion fame! I'd gotten to know Eloy as a friend through CocoaPods and, just before leaving Amsterdam, had the pleasure of getting to know him in-person as a colleague."
  ...
  - title: "Peer Labs"
    description:
      - 'One thing I missed most from Amsterdam was the sense of developer community that [Appsterdam](https://appsterdam.rs) created. My friend, [Samuel](https://twitter.com/samuelgoodwin), ran a "Peer Lab", a weekly meetup for developers to work independently, but in the same space. I looked forward to it each week.'
      - "After moving to New York, I quickly [set up a Peer Lab at Artsy](http://artsy.github.io/blog/2015/08/10/peer-lab/)."
  - title: "Art"
    img: "./armory.jpg"
  ...
  - title: "Germany Tour"
    ...
    description:
      - "Quickly after moving to New York, my wife and I returned to Europe so I could present at a few conferences. First to Istanbul, then to Berlin. The conferences were a month apart and so we spent a month touring around Germany, couch surfing with friends. [I planned the trip on GitHub](https://github.com/ashfurrow/EuroTrip-2015) and made a lot of friends along the way."
  - title: "Teaching & Learning at UIKonf"
    img: "./uikonf.jpg"
    imgAlt: "Photo of me presenting at a conference"
    description:
      - "In 2014, I attended UIKonf and had a great time. I returned the following year to present a talk titled [*Teaching & Learning*](https://www.youtube.com/watch?v=SjjvnrqDjpM). The thesis of my talk was that sharing knowledge is good, it's good for you, and you should do it."
  ...
  - title: "Life at Artsy"
    ...
    description:
      - 'After UIKonf uploaded the video recording of my *Teaching & Learning* talk, I shared it within Artsy. That afternoon, Carter (Artsy''s CEO) called me on the phone. He said "I watched your talk. Let''s do it." And so Artsy created a new blog, [*Life at Artsy*](https://www.artsy.net/life-at-artsy).'
      - 'My colleague, Remy Ferber, worked on the initial post, [*Open-Sourcing Company Culture at Artsy*](https://www.artsy.net/article/remy-ferber-open-sourcing-company-culture-at-artsy). In it, she says "By promoting openness, we mitigate fear of judgment and embrace our mistakes as positive experiences to learn from and share with others." This is really key – it speaks to a concept that I didn''t yet have the vocabulary to describe: psychological safety.'
  ...
  - title: "Loosely Held Strong Convictions"
    ...
    imgAlt: "Photo of me presenting at a conference"
    description:
      - "I gave a talked titled [*Loosely Held Strong Convictions*](https://www.youtube.com/watch?v=hlLhtWLghGA) in Italy in 2015. I wanted to talk about something that was more important than just programming computers. I spoke about why humans believe the things we do, how we think about our own beliefs, and why we divide ourselves into groups. Heavy stuff for a technology conference."
      - "After the conference, I ran into some conference attendees at the airport. They told me something I'll never forget: they told me that my talk had made them think about the [migration crisis](https://en.wikipedia.org/wiki/European_migrant_crisis) with a new perspective."
  ...
  - title: "Building Communities"
    description:
      ...
      - "I decided that the next skill that I wanted to master was [build online communities](https://ashfurrow.com/blog/building-online-communities/). I considered Artsy Engineering one type of online community, while [Moya](https://github.com/Moya/Moya) was another type."
  ...
  - title: "The Auctions Team"
    ...
    description:
      ...
      - "Our first big event was was [Sotheby's Input/Output](https://www.artsy.net/article/sotheby-s-sotheby-s-first-online-only-auction-input-output) auction. Sotheby's is a big player in the auction world, so working with them was a big deal for Artsy. This was kind of stressful! But was a good preparation for the stress that would come next year, building Live Auctions Integration."
  - date: "2016"
  - title: "Film!"
    img: "./film.jpg"
    ...
    description:
      ...
      - "My everyday photography is now [on my Instagram account](https://www.instagram.com/ashfurrow/) and [I also have a photo blog](https://photos.ashfurrow.com)."
  - title: "Live Auctions Integration"
    ...
    description:
      ...
      - "January kicked off six months of *intense* work on the nascent Auctions team, building Live Auctions Integration (LAI). At the time, Artsy only supported [*timed auctions*](https://artsy.github.io/blog/2014/04/17/building-an-english-auction-with-mongodb/): the auction had a pre-set end time and, when that time arrived, whoever was the highest bidder on each lot won that lot."
  ...
  - title: "Coalition for Queens"
    description:
      - "Around this time, Orta connected me to a non-profit coding bootcamp called Coalition for Queens (they have since rebranded as [Pursuit](https://www.pursuit.org)). C4Q provides education for underrepresented groups in tech, and Orta and I started consulting on their iOS curriculum."
  ...
  - title: "SINFO"
    ...
    description:
      - "Early in the year, I took a trip around the world. First, to Lisbon for the [SINFO](https://sinfo.org) conference, and then onto Tokyo for try! Swift."
  ...
  - title: "LAI Launch"
    ...
    description:
      ...
      - "The launch was a total success. [Our software worked like a charm](https://artsy.github.io/blog/2016/08/09/the-tech-behind-live-auction-integration/), and after the launch, we were all encouraged to take as much time off as we needed."
  - title: "Missing WWDC"
    img: "./buttons.jpg"
  ...
  - title: "Steven Universe"
    ...
    description:
      ...
      - "[I started writing about the show](https://ashfurrow.com/blog/steven-universe-and-masculinity/) pretty quickly. This came at a pretty important time for me, since I was earnestly researching team dynamics, which is an important theme of the show. Orta called *Steven Universe* 'the most Ash Furrow show', which I took as quite the compliment."
  ...
  - title: "Scaling LAI"
    description:
      ...
      - "Our focus turned from building out LAI to scaling it, and scaling tools for our colleagues in Auctions Ops. I found this work really fulfilling. [There were lots of opportunities for my professional growth](https://artsy.github.io/blog/2018/02/02/artsy-apogee/). Something about making my colleague's jobs easier just felt satisfying in a new, fresh way to me."
  ...
  - title: "A Cohering Philosophy of Software Development"
    ...
    description:
      - 'When you go to my website''s homepage, [ashfurrow.com](https://ashfurrow.com) *used* to just show a list of recent blog posts, but [as of this pull request](https://github.com/ashfurrow/blog/pull/285), it links to what I considered "important" blog posts.'
      - 'These initial "important" blog posts were each an attempt to apply what I had learned about team dynamics and turn them into a coherent narrative. I have since taken on the term "compassionate software developer", which I discovered from [April Wensel](https://twitter.com/aprilwensel) of [Compassionate Coding](https://compassionatecoding.com). I''m a big fan of her work.'
      - "Even though I had these initial blog posts, it would still be some time before my thoughts cohered around a central set of ideas. In 2018, I would give a talk (also transcribed it into a blog post) called [Building Better Software by Building Better Teams](/blog/building-better-software-by-building-better-teams/). In it, I lay out the evidence-based business value of compassionate software development, with instructions to get started and links to jumping off points."
  ...
  - title: "React Native Feels"
    description:
      - "In 2016, Artsy had introduced React Native into our iOS app. I had largely ignored it because I thought, and hoped, that it would fizzle out. To my dismay at the time, it didn't. I eventually wrote [this blog post](https://ashfurrow.com/blog/swift-vs-react-native-feels/) early 2017 about dealing with these feelings, but in my opinion, the post hasn't aged well. It still has me holding on to Swift as the future of iOS at Artsy."
  ...
  - title: "Mastodon"
    img: "./elephantfriend.png"
    imgAlt: "An elephant, Mastodon's logo"
    description:
      - "Early in 2017, [I created a Mastodon instance](/blog/mastodon/) called [mastodon.technology](https://mastodon.technology). I'm not going to go into detail here, about how Mastodon works or what an instance is, but my experiences administrating mastodon.technology have been pretty positive."
      - 'I moved to Mastodon because [Twitter had too many Nazis](https://www.vice.com/en_us/article/783akg/mastodon-is-like-twitter-without-nazis-so-why-are-we-not-using-it) (it still does) and when I created my own instance, I got to establish a [Code of Conduct](https://mastodon.technology/@ashfurrow/99664). I made sure to include a "no Nazis" policy. Cool! It felt nice to say "no" to fascists. But it also made my instance a target (and as its admin, I became a target too).'
      - "I would later [get involved](/blog/contributing-to-mastodon/) deeper with Mastodon, contributing code fixes to its React and Rails code, as well as documentation. It was a very different kind of open source project than I was used to, and I learned a lot."
  ...
  - title: "Stepping Back from Moya"
    ...
    description:
      - "In 2017, [Stepped back from Moya](https://ashfurrow.com/blog/stepping-back-from-moya/), which was a big deal. Moya had become a huge project – one of the most popular open source iOS libraries – and I had successfully deprecated my involvement in the project. Since my departure, the project has continued to grow and evolve."
  ...
  - title: "Guitar Debut"
    description:
      - "Late in 2016, I learned the ukulele and later the guitar. At Artsy's annual employee art show (the *Artsy Salon*), [I performed guitar in front of a live audience for the first time](/blog/guitar-debut/)."
      - "I was used to performing music from back in high school, when I played piano and saxophone. But this was different, mainly because *I was singing* and I really hated my voice. If you [watch the recordings](https://www.youtube.com/watch?v=582iYsdMHjA&list=PLBygl72DbBTHb0kIkmmzOx9gUyNvEwaUO&index=2&t=0s), you can see my legs shaking."
  ...
  - title: "Coding in React Native"
    description:
      - "By mid 2017, I had began contributing to [Artsy's React Native code.](https://github.com/artsy/emission) My fears and doubts persisted, but I pushed through them and started enjoying writing React Native user interfaces *way* more than I enjoyed writing similar UI in Swift/Objective-C. I was hooked."
  ...
  - title: "Side Effects"
    description:
      - "The medication I'd found that was helping manage my depression has a rare, but serious (and often permanent) side-effect. A neurological side-effect. I started exhibiting the symptoms and [had to stop taking my medication right away](/blog/some-updates/)."
  ...
  - title: "Changes at Artsy"
    description:
      ...
      - "I'm putting this in the timeline at the beginning of the year, but this affected most of 2018. It was a shame, but a lot of us learned quite a bit. [I played a (small) role in helping to remedy the tension](https://artsy.github.io/blog/2019/04/19/having-a-coffee-with-every-engineer/), but like any change, it had a permanent effect on our culture."
  ...
  - title: "Buying into React Native"
    description:
      ...
      - "While I was learning, I wrote about my experiences. Since most React Native developers come from a web background, I [tried to make React Native less intimidating](/blog/react-native-starter-resources-for-native-developers/) to native iOS developers."
      - "[I wrote a blog post on the official React Native blog](https://facebook.github.io/react-native/blog/2018/05/07/using-typescript-with-react-native). Using my perspective with one foot in both the JavaScript and iOS develop worlds, I looked at what made React Native hard to approach, and wrote *[JavaScript is Good, Actually](/blog/javascript-is-good-actually/)*, a blog post which certainly didn't help my alienation from the iOS developer community."
  ...
  - title: "Mission Accomplished. Kind of."
    description:
      - "In March, after months of ignoring my psychiatrist's advice, I started seeing a specialist in Cognitive Behaviour Therapy. It was the exact intervention that my depression needed, and in only seven sessions, [I had the skills I needed to manage my emotions](/blog/all-i-can-say-is-im-excited/)."
  ...
  - title: "Guitar Progress"
    ...
    description:
      - "I continued learning the guitar. I took some private lessons, eventually, but was mostly self-taught. [I performed at the Artsy Salon again](https://www.youtube.com/watch?v=1pIf5VPhmco&list=PLBygl72DbBTHIpDE63lPSvddwHs6FbgRQ), and was a lot less nervous. [I played at a jam session my friend organized](https://twitter.com/ashfurrow/status/1010889745398927361). I even [recorded myself playing music every day for a month](/blog/just-play/)."
  ...
  - title: "The Case for React Native"
    description:
      ...
      - 'I wrote *[The Case For React Native](/blog/the-case-for-react-native/)* to explain why I thought React Native is a good fit for "a lot of iOS apps (many? most?)". The tl;dr is that React itself is worth it. Additionally, TypeScript is good enough to make any Swift developer feel at home writing code that gets compiled down to JavaScript.'
  - title: "Artsy Engineering Guiding Principles"
    description:
      - "At the end of 2018, after a lot of growth, Artsy Engineering [defined its guiding principles](https://artsy.github.io/blog/2018/08/22/engineering-guiding-principles/). This was a collaborative effort, to define (and [open source](https://github.com/artsy/README/blob/master/culture/engineering-principles.md)) a list of first principles that could be referred to. These are useful for making decisions, giving feedback, building new software, fixing old software, lots of stuff. I cite them often in discussions at work – as a shared foundation of our culture, they become more and more valuable the more they are used."
  - title: "Uncertain Identity"
    img: "./cultureamp.png"
    imgAlt: "Screenshot of a survey question inquiring my sexuality, with Bisexual as the selected answer"
    description:
  ...
  - title: "My First JavaScript Meetup Talk"
    description:
      - "A big part of my work in the iOS developer community has been delivering talks at conferences and meetups. [My speaking page](/speaking/) lists dozens of talks I've given over the years. In late 2018, I gave [my first talk at a JavaScript meetup](/blog/first-js-meetup-talk/)."
      - "I live-coded a TypeScript linter plugin that used the TypeScript AST to apply auto-fixits for [De Morgan's Laws](https://en.wikipedia.org/wiki/De_Morgan%27s_laws). The exercise was pedagogical – only meant to teach how one can build other, more useful tools. It was difficult, but I had a blast, and came away with a richer appreciation of the JavaScript community and their enviable relationship to their own tools."
  - title: "Today I Learned..."
    description:
      ...
      - 'I started a ["Today I Learned" repository](https://github.com/ashfurrow/TIL/issues) to record at least one thing I''ve learned, everyday. It''s difficult and I don''t always remember, but it''s gotten me in the habit of thinking about what I learn, and it''s become a repository of notes and links to useful resources for me.'
      - "[Sometimes I learn specific technical things](https://github.com/ashfurrow/TIL/issues/53). [Sometimes I learn about team management](https://github.com/ashfurrow/TIL/issues/67). [And sometimes I learn really personal stuff](https://github.com/ashfurrow/TIL/issues/125). It's all up for grabs."
  - title: "Physical Therapy"
    description:
      - "Late in 2018, I finally took up a recommendation from some colleagues to see their physical therapist. I'd been battling wrist pain for years but after a doctor gave up on helping me, I kind of gave up too. I'm glad I listened to them, because [the physical therapy been very successful](/blog/learning-to-walk/) and the therapist [has had a truly life-changing effect on me](/blog/learning-to-run/)."
  ...
  - title: "Discover Team"
    description:
      - "Early in the year, my manager Eloy asked me if I was interested in moving into a Technical Lead role on Artsy's Discover team. [I wrote about it at the time](https://ashfurrow.com/blog/reflecting-on-5-years-at-artsy/), and things went well for a few months. Sadly, it wasn't to last."
  ...
  - title: "End of Medication"
    description:
      ...
      - "It took a few months, [but I finally did it](https://twitter.com/ashfurrow/status/1124461096969097217)."
  - title: "Mastodon Going Strong"
    ...
    description:
      - 'It''s been nearly three years since I launched [mastodon.technology](https://mastodon.technology), and it''s going really well! I''m more of a lurker than a poster on the fediverse, but I do try to send out a "good morning" post every day: a meme, a photo I took on the walk to work, a selfie, something to just say "good morning." ([Here is my 2018 thread](https://mastodon.technology/@ashfurrow/101291161385779358), and [here is the 2019 thread so far](https://mastodon.technology/@ashfurrow/103300784680224031)). I like it as a user: most of the time I spend on social media is spent on Mastodon. But I also like it as an admin: I get to help create the kind of online community that I''d like to see in the world.'
      - "At time of writing, my instance has 19 344 users (many are inactive, only 1 161 have logged in within the past two weeks). Keeping up with software updates and server maintenance turned out to be the easy part – I know my way around computers, and have [shared what I learn as I go](https://www.patreon.com/ashfurrow/posts). The harder part was building the community."
  ...
  - title: "City Guides"
    ...
    description:
      - "After the Discover team dissolved, I joined Artsy's Grow team to help them complete [City Guides](https://www.architecturaldigest.com/story/artsy-app-changing-the-game-for-art-and-design-lovers), as an in-progress project. I wasn't used to joining in-progress work; I prefer to be involved throughout the product development process: brainstorming with stakeholders, providing early design feedback, that kind of stuff. This was a new challenge."
  ...
  - title: "Artsy Departures"
    description:
      ...
      - "They each left for their own reasons – ready to move on to the next challenge. [You can read Orta's reflections on leaving Artsy here](https://orta.io/on/leaving/artsy). It all makes sense, but I can't help but feel a sense of mourning for an Artsy that doesn't exist anymore. That won't and can't exist anymore."
  ...
  - title: "Staff Engineer"
    description:
      - "I had been working towards a promotion to Staff Engineer for a long time. The job title has no universally-agreed upon definition (although [Artsy's Engineering Career Ladder is open source](https://github.com/artsy/README/blob/master/careers/ladder.md)). My take on it is this: as a Senior Engineer, it was my responsibility to be productive. As a Staff Engineer, it's my responsibility to make *everyone* productive: my team, Artsy as a whole, and the entire software industry. Everyone."
      - "I mentioned [in this blog post](/blog/reflecting-on-5-years-at-artsy/) that I was excited to have the institutional authority to execute on the cultural authority that I have accrued at Artsy. It's a lot of responsibility and I'm growing in new and challenging ways."
  - title: "Artsy Leadership Changes"
    description:
      - "Artsy had some leadership changes this year. Our CTO dB made sure to hire a VP of Engineering to set us up for success, before [he returned to individual contributor work](https://code.dblock.org/2019/11/17/the-pros-and-cons-of-going-from-management-back-to-ic.html). Artsy also [hired a new CEO](http://files.artsy.net/documents/artsy-names-new-ceo.pdf). These changes are felt at every level of the company. After the changes to the Product/Engineering organization in 2018, I felt prepared to handle these changes at Artsy."
  - title: "Green Card Process Completes"
    img: "./greencardend.jpg"
  ...
  - title: "Coming Out"
    img: "./comingout.jpg"
    imgAlt: "A panel from a comic that says How do I feel? Oh you know. Relieved. Excited. Devastatingly embarrassed by my own idiocy."
    description:
      - "So yeah. After coming out to myself as bisexual, I had to figure out what to do next. The decision of whether to tell anyone else – my wife, my family, or even the whole world. I didn't want to for a long time, but I realized that I didn't want to because I was afraid. And after years of hiding, I didn't want to be afraid anymore. I told my wife, who totally supported me, and then waited for our immigration process to complete (our marriage needed to be verified by the United States government, and I wasn't taking any chances). Finally, [I came out in a blog post](/blog/coming-out/)."
      - "I wrote the blog post at Peer Lab in the morning, but in my head, I'd been writing it for months. I got my wife to read it over for typos (she often helps me edit my posts, thank you Ashley 🙏) and then pushed it into the world. [I tweeted about it](https://twitter.com/ashfurrow/status/1137463336235347969). People responded with overwhelming support and positivity. It felt amazing."
      - "[Coming out late in life](https://thenib.com/i-came-out-late-and-that-s-okay) isn't a common story you hear about, and it involves navigating a lot of unfamiliar emotions. I'm having to figure things out, but I'm not alone. And at last, I get to be my whole self."
      - "Image credit: [Alison Wilgus](https://twitter.com/aliwilgus)."
  - title: "Stepping Up"
    description:
      - "Near the end of 2019, [my manager Eloy](https://twitter.com/alloy/status/1203981302652899329) left Artsy. I miss working with him already, but I'm excited for what's coming next for him."
  ...
  - title: "Mobile Experience Team"
    ...
    description:
      - "When I returned from vacation in August, I found an [RFC](https://github.com/artsy/README/blob/master/playbooks/rfcs.md) in my inbox: should Artsy have a mobile team again? And I was *very* excited."
      - 'Artsy *had* a Mobile team when I started, but it was dissolved in 2016. [We adopted React Native](https://artsy.github.io/blog/2019/03/17/three-years-of-react-native/), in part, to ["de-silo" our engineering teams](https://github.com/artsy/README/blob/master/culture/engineering-principles.md#de-silo-engineers). It worked, but it had some consequences on the software we built (see: [Conway''s Law](https://en.wikipedia.org/wiki/Conway%27s_law)). It was time to dedicate a team to making the app awesome.'
...
{% personalTimeline timeline_entries %}
