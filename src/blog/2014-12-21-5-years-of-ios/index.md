...
timeline_entries:
  ...
  - title: "Opened Xcode"
    ...
    description:
      ...
      - "I also had a few reference books and some help from a friend. [Jason Brennan](http://twitter.com/jasonbrennan) and I talked a lot over Google Wave. He helped me with everything from syntax of Objective-C to quirks of Xcode."
  - title: "Coffee Timer"
    img: "./coffeetimer.png"
  ...
  - title: "WWDC 2010"
    ...
    description:
      ...
      - "The conference itself was amazing. The line for the keynote had as many people as are in my hometown. I made some friends inline – particularly [Philippe Casgrain](http://twitter.com/philippec) and [Daniel Kennett](http://twitter.com/iKenndac)."
  ...
  - title: "Released 500px for iPad"
    ...
    description:
      - "7 weeks into my tenure at 500px, we released the iPad app. I hated it – it was missing features and it had bugs. Everyone else loved it – it was covered on [Tech Crunch](http://techcrunch.com/2011/10/17/gorgeous-photos-tablet-browsing-500px-debuts-new-ipad-app/) and a number of other tech rags. I was not used to this feeling – knowing that something I had made was imperfect but having it praised by others."
  - title: "My First Podcast"
    img: "./podcast.jpg"
    imgAlt: "Photo of a microphone"
    description:
      - "Encouraged by our coworker, three of us started a podcast. [Tom](http://twitter.com/tomcreighton), [Adam](http://twitter.com/adamshutsa), and I would take an hour or so on Friday afternoons to have some fun, record musings on startup life, tech news, and design. Our [early episodes](http://themasterbranch.com/2011/12/force-episode-three/) had terrible audio quality, but I would slowly get better at recording and editing podcasts. These first episodes were some of the most fun I'd ever had."
  - title: "Storygram"
    img: "./storygram.png"
    imgAlt: "Screenshot of an iPad app with rainbows and a Polaroid camera and spray paint."
    description:
      - "At a hackathon organized by 500px, Tom and I worked together to create an app called Storygram. You would use it to collect photos from your Instagram account into a 500px photo blog post. Because we ~~are both immature children~~ have great senses of humour, we tried to make the design as ridiculous as possible. By the end of the weekend, we had something we would submit to the App Store. Since we were 500px employees and ineligible for a prize, the judging panel would award us an honourable mention."
  - date: "2012"
  - title: "TACOW"
    description:
      - "I had been attending [TACOW](http://www.meetup.com/tacow-org/) a Toronto-based iOS/OS X/WebObjects developers meetup group. I began attending when I first moved to Toronto and in 2012, I started giving the occasional presentation. These were my first non-academic talks."
  ...
  - title: "Job Interview at Apple"
    ...
    description:
      - "One day, I got an email from an Apple recruiter about a position on the Siri UI team. I had a few phone interviews and was flown down for a day of [interviews in Cupertino](https://ashfurrow.com/blog/my-job-interview-with-apple/). Apple decided I wasn't ripe yet, and I decided that I didn't really want to work for Apple."
  - title: "Photo Hour"
    img: "./photohour.png"
    imgAlt: "An app icon that looks like the back of a camera with a sunrise on the camera screen"
    description:
      ...
      - "With Adam's help, I designed the application before writing any code. He made me a wonderful icon and I put it on the [App Store](https://itunes.apple.com/ca/app/photo-hour/id524263013?mt=8)."
  - title: "WWDC 2012"
    img: "./wwdc2012.jpg"
  ...
  - title: "New Publisher"
    description:
      - "Noticing my expertise in iOS 6 APIs, and wanted to capitalize on developer interest in the subject, a new publisher approached me about writing a book for them. The book is now in its [second edition](http://www.amazon.com/iOS-UICollectionView-Complete-Mobile-Programming-ebook/dp/B00CFLTD50/ref=sr_1_2?ie=UTF8&qid=1419356862&sr=8-2&keywords=uicollectionview)."
  ...
  - title: "Plunged Into Depression"
    description:
      ...
      - "To make a bad situation worse, my wife was on a work placement in Thunder Bay during the two months I was working my ass off. Having been together six years at that point, I wasn't accustomed to handling stress by myself. I fell [further into depression](https://ashfurrow.com/blog/depression-sucks/) than I ever had before and nearly killed myself."
  ...
  - title: "Objective-C Vitamins Talk"
    description:
      - "Between 500px and Teehan+Lax, I gave a talk called [Objective-C Vitamins](https://speakerdeck.com/ashfurrow/objective-c-vitamins). This put me on the radar of the CocoaPods team."
  - title: "Started at Teehan+Lax"
    description:
      - "In February, I started at [Teehan+Lax](http://teehanlax.com), a digital agency in Toronto. Our values significantly overlapped, giving me an opportunity to contribute and create open source projects, as well as write technical blog posts. I also learnt a great deal about design and business, especially from Jon Lax. I felt privileged to work there."
  - title: "Medication"
    description:
  ...
  - title: "Started Springboard"
    img: "./springboard.jpg"
    imgAlt: "Podcast icon with a microphone and a subtitle that says 'Springboard'."
    description:
      - "While still producing the first podcast I cohosted with Tom and Adam, I branched out into doing a podcast of my own: an interview show discussing the origins of experienced developers. I called it *[Springboard](http://springboardshow.com)*, a pun on the name of the iOS system that starts apps when you tap them."
  ...
  - title: "Start at Artsy"
    ...
    description:
      - "Artsy is a unique company. They value things like compassion and love while working with an 'art meets science' mentality to accomplish something really worthwhile."
