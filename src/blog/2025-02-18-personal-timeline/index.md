...
timeline_entries:
  - title: Childhood
    description: "I mostly just wanted to include this photo. I'm from a small town in New Brunswick."
    img: ./childhood.jpeg
    imgAlt: Photo of me as a kid
  - title: Computers
    description: "If you've never played *Where in The World is Carmen Sandiego* on a 486 then have you really lived?"
    img: ./computer.jpeg
    imgAlt: Photo of my sister and I looking at an old CRT computer monitor together.
  ...
  - title: First iOS App
    ...
    img: ./coffeetimer.jpeg
    imgAlt: Screenshot of an iOS app for making coffee
  - title: WWDC 2010
    description: "I was awarded a free student ticket from Apple to attend their World Wide Developer Conference in 2010. It kick-started my whole career."
    img: ./wwdc.jpeg
    imgAlt: Photo of me standing in WWDC 2010
  - title: Got Married
    description: "At the end of our undergraduate degrees, my wife and I got married (to each other)."
    img: ./wedding.jpeg
  ...
  - title: First Camera
    description: "I bought my first camera, which made sense working at a photography software company. I got really into it, eventually developing my own film."
    img: ./camera.jpeg
    imgAlt: Photo of a Canon DSLR
  - title: Moved to Amsterdam
    description: "My wife and I moved to Amsterdam in 2014. Why? Basically, on a whim. But we knew that our mid-twenties was the time to go have an adventure."
    img: ./amsterdam.jpeg
    imgAlt: Photo of Amsterdam and the Amstel river
  - title: Artsy
    description: "In 2014, I started working for [Artsy](https://artsy.net). I was inspired by their mission: to make all the world's art accessible to anyone with an internet connection."
    img: ./artsy.jpeg
    imgAlt: Photo of a building with the Manhattan skyline in the background.
  - title: Moved to New York
    description: "We moved to New York in 2015. It still feels like a dream. Here are my two cats at the Artsy office while we waited for our apartment to become available."
    img: ./nyc.jpeg
  ...
  - title: Speaking
    description:
      - "Starting around 2013 and continuing until 2020, I frequently gave [conference presentations](/speaking) about software development."
  ...
  - title: Learned Guitar
    description:
      ...
      - "[Check out my SoundCloud](https://soundcloud.com/ash-furrow)."
    img: ./guitar.jpeg
    imgAlt: Photo of me playing guitar.
  - title: Moved back to Fredericton
    description: "The novel coronavirus pandemic of 2020 led my wife and I to re-evaluate what we wanted from life. We decided to move home to Canada, and back to Fredericton."
    img: ./uhaul.jpeg
    imgAlt: Photo of a UHaul truck in New York
  - title: Shopify
    description: "I worked for Shopify for over two years, spending most of that time creating [an SDK for the Shop app](https://shop.app/minis/docs/)."
    img: ./shopify.jpeg
    imgAlt: Screenshot of a Shop Mini created with the SDK I built
  - title: Float
    description: "I started at Float in 2023 to build the company a mobile app. It's been a success so far, but I still have a lot left to accomplish."
    img: ./float.jpeg
    imgAlt: Photo of an airport advertisement for Float
  - title: Got a New Keyboard
    description: "This was originally a testing image to see if this timeline React component was working, but Phoebe insisted that I include it."
    img: ./keyboard.jpeg
